...
public class ShowUserForm extends javax.swing.JDialog {
   ...
   public void recibeDatosUserMenu(int idEmp, String nombres, String apellidos, String tipoDocumento, String documento, String correo ){
       //Convertimos el id Emp de entero a texto    
       txtId.setText(""+idEmp);
       txtNombres.setText(nombres);
       txtApellidos.setText(apellidos);
       txtTipoDoc.setText(tipoDocumento);
       txtDocumento.setText(documento);
       txtCorreo.setText(correo);
       //los campos editables son:  nombre, aellido, correo
      /* if (nombres.isEmpty()) {
           ...
           String query= "UPDATE `empleados` SET `nombreEmp`= "+ nombres+ "`apellidos` "+apellidos +",``correo" + correo+ "`WHERE idEmpleado=" + idEmp+ ";";
    ...
    public void ActualizarEmpleado(){
          //convertimos el sstring en entero
        int idEmp = Integer.parseInt(txtId.getText());
        //capturamos los calores ediatables
        ...
        //todos los campos fueron diligenciados
        String query= "UPDATE `empleados` SET `nombreEmp`='" + nombres+ "`apellidos`="+ apellidos+ "`correo`="+ correo+ "WHERE `idEmp` = "+idEmp;
           try{
               connection = conexion.getConnection();
               st = connection.createStatement();
               st.executeUpdate(query);
               JOptionPane.showMessageDialog(this, "Se han actualizado los datos de los empleados","", JOptionPane.INFORMATION_MESSAGE);
           }catch(SQLException e){
               JOptionPane.showMessageDialog(this, "No fue posible actualizar los datos de los empleados", "", JOptionPane.ERROR_MESSAGE);
        }
           this.dispose();
    }
    }
    public void EliminarEmpleado(){
        //consulltamos el id del empleado
        int idEmp = Integer.parseInt(txtId.getText());
        //Validar si elusuario no ha seleccionado un empleado
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtTipoDoc, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
     //Convertimmos el String en Entero
        ActualizarEmpleado();
     
    }//GEN-LAST:event_btnEditarActionPerformed

    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        this.dispose();//cerrar la ventana regresar a ala anterior
